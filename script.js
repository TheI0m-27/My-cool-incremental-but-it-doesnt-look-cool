...
if (points > 1e70) points = 1e70;
god.innerText = "You have " + Math.floor(points) + " points";
if (points >= 1e6) god.innerText = "You have " + points.toExponential(2) + " points";
if (points >= 10000 && milestone1allow === 1) milestone1.style.visibility = "visible";
if (points >= 1e6 && milestone2poop === 1 && milestone2allow === 1) milestone2.style.visibility = "visible";
if (points >= 1e8 && milestone3poop === 1 && milestone3allow === 1) milestone3.style.visibility = "visible";
if (points >= 1e14 && milestone4poop === 1 && milestone4allow === 1) milestone4.style.visibility = "visible";
if (points >= 1e30 && milestone5poop === 1 && milestone5allow === 1) milestone5.style.visibility = "visible";
...
poop3buy += 1;
if (poop3buy === 3) poop3.style.visibility = "hidden";
}
};
...
if (random === 1) points /= loadUnboost;
else points *= loadBoost;
updateGodText();
setTimeout(() => {
load.disabled = false;
}, 60000);
...
if (updateUpgrade1 === true) sPupgrade.innerText = "Current: * " + (sP * 1e6).toExponential(2);
if (updateUpgrade2 === true) sPupgrade2.innerText = "Current: * " + (sP * 1e6).toExponential(2);
}
...
sPupgrade.style.visibility = "hidden";
}
};
